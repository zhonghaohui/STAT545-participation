...
### select first, arrange the rest of columns in desc order
select(gapminder, country, gdpPercap:continent)

####factors means something that is not numeric, like country, continent
...
# pipe operator: %>%:ctrl+shift+m -windows;cmd+shift+m -mac

#execute one line of R code: mac: cmd+return; windows:ctrl+enter. make sure click the line first
...
## select takes columns, filter takes rows
