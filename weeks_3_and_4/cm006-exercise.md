...
```
## Error in select(gapminder, FILL_THIS_IN): 没有"select"这个函数
```
...
```
## Error in select(gapminder, country, continent, year, lifeExp): 没有"select"这个函数
```
...
```
## Error in select(gapminder, FILL_THIS_IN, FILL_THIS_IN): 没有"select"这个函数
```
...
```
## Error in rename(gapminder, FILL_THIS_IN): 没有"rename"这个函数
```
...
```
## Error in arrange(gapminder, FILL_THIS_IN): 没有"arrange"这个函数
```
...
```
## Error in arrange(gapminder, FILL_THIS_IN, FILL_THIS_IN): 没有"arrange"这个函数
```
...
```
## Error in arrange(select(gapminder, year, lifeExp, country), year, lifeExp): 没有"arrange"这个函数
```
...
```
## Error in gapminder %>% filter(FILL_THIS_IN): 没有"%>%"这个函数
```
...
```
## Error in gapminder %>% mutate(FILL_THIS_IN): 没有"%>%"这个函数
```
...
```
## Error in gapminder %>% transmute(FILL_THIS_IN): 没有"%>%"这个函数
```
